...
from agents.autopilot.artifacts import (
    ResearchArtifact,
    StrategyArtifact,
    ContentArtifact,
    DesignArtifact,
...
from agents.autopilot.skill_loader import build_stage_prompt
...
async def run_design(
    ...
    try:
        from agents.autopilot.brand_memory import format_brand_for_design_prompt
...
async def run_images(
    ...
    from agents.autopilot.image_gen import (
    ...
    brand_context = None
    try:
        from agents.autopilot.brand_memory import get_brand_context_for_images
        from utils.db import _connect as db_connect
        from memory.store import ClientMemoryStore
        _store = ClientMemoryStore(db_connect)
